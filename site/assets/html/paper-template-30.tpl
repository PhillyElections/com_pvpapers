...
<section class="block top-border">
    <div class="fifty left">
        ...
        COUNTY OF PHILADELPHIA NOMINATION PAPER</h3>
...
<section class="block">
    <div class="fifty left">
        <ul>
            ...
            <li>
                Paper may be used to submit for nomination the name of one candidate for one office only.</li>
            <li>
                Paper can only be circulated between {START_MONTH_EN} {START_DAY}{START_DAY_SUFFIX} and {FINISH_MONTH_EN} {FINISH_DAY}{FINISH_DAY_SUFFIX}, {FINISH_YEAR}.</li>
        </ul>
        <p>
            We the undersigned, all of whom severally declare that we are qualified electors of Philadelphia County and of the political district set forth above, that we are registered and enrolled members of the political party set forth above, and have signed no paper inconsistent herewith, do hereby paper the City Commissioners to have the candidate whose Name, Occupation/Profession, and Place of Residence are set forth above, certified to the County Board of Elections to be printed on the Primary Ballot of said Party, for the Year and Office set forth above.</p>
    </div>
    <div class="fifty right line-left">
        <ul>
            <li>
...
<section class="block">
    <div class="fifty left">
        ...
        <p>I do swear (or affirm) that I am a qualified elector, duly registered and enrolled as a member of the political party designated in this nomination paper; that my residence is as set forth below; that the signers to the foregoing paper signed the same with full knowledge of the contents thereof; that their respective residences are correctly stated therein; that each signed on the date set opposite his or her name; that to the best of my knowledge and belief, the signers are qualified electors, registered and enrolled members of the political party and of the political district referred to in this paper, and that they are residents of the City &amp; County of Philadelphia.</p>
