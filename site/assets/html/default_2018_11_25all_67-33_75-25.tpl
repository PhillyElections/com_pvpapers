...
<section class="block">
    ...
    <div class="fifty right line-left">
        ...
        <div class="ss"><span class="left eighty-five">ESTADO DE PENSILVANIA / CONDADO DE FILADELFIA</span></div>
    ...
    <div class="left seventy-five">
        <div>
            ...
            <div class="sixty-seven left">
                <br>
                <h4>Sworn to and subscribed before me this / Jurado y suscrito ante m&iacute; el <span class="line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> day of / d&iacute;a de <span class="line">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> of / de {FINISH_YEAR} </h4>
                <div class="full">&nbsp;</div>
                <div class="full">&nbsp;</div>
